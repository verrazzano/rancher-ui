...
export default Component.extend(ViewNewEdit, ChildHook, {
  ...
  getCompartmentId: computed('config.vcnCompartmentId', () => {
    return get(this, 'config.vcnCompartmentId');
  }),

  getVcnName: computed('config.vcnName', () => {
    return get(this, 'config.vcnName');
  }),

  getControlPlaneSubnet: computed('config.controlPlaneSubnet', () => {
    return get(this, 'config.controlPlaneSubnet');
  }),

  getLoadBalancerSubnet: computed('config.loadBalancerSubnet', () => {
    return get(this, 'config.loadBalancerSubnet');
  }),

  getWorkerNodeSubet: computed('config.workerNodeSubnet', () => {
    return get(this, 'config.workerNodeSubnet');
  }),
