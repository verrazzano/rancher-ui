...
export default Component.extend(ClusterDriver, {
  ...
  // computed wrapper for fetching compartments -- ensures dependencies
  fetchedCompartments: computed('fetchCompartmentsTask', 'primaryResource.cloudCredentialId', function() {
    return this.get('fetchCompartmentsTask').perform();
  }),
  ...
  // asynchronously fetch list of compartments from oci. Called indirectly from lifecycle didRender() method via fetchedCompartments computed
  fetchCompartmentsTask: task(function *() {
    if (!get(this, 'compartments')) {
      const token = get(this, 'primaryResource.cloudCredentialId');
